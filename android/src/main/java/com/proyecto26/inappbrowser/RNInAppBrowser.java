...
public class RNInAppBrowser  {
  ...
  public void open(Context context, final ReadableMap options, final Promise promise, Activity activity) {
    ...
    prepareBottombar(builder, context);
  ...
  private void prepareBottombar(CustomTabsIntent.Builder builder, Context context) {

    builder.setSecondaryToolbarViews(BottomBarManager.createRemoteViews(context, true),
            BottomBarManager.getClickableIDs(), BottomBarManager.getOnClickPendingIntent(context));
  }
